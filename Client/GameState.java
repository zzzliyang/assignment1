...
public class GameState implements Serializable {
    ...
    public GameState(String serverPlayer, String backupPlayer, List<Pair<Integer, Integer>> coinsLocation, Map<String, Pair<Integer, Integer>> playersLocation, Map<String, Integer> playersScore) {
